...
import type { LegalBasis, LegalReference, LegalText, ApiResponse } from '@/lib/types';
...
// Re-export pure helper functions from utils for backward compatibility
export { getLegalText, flattenLegalTexts, getLegalBasisTitle } from '@/lib/utils/legislation';
