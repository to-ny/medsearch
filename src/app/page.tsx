      ...
      <div className="max-w-2xl w-full text-center">
        ...
        <div className="text-sm text-gray-500 dark:text-gray-400">
          ...
          <div className="flex flex-wrap justify-center gap-2">
            <ExampleChip query="paracetamol" />
            <ExampleChip query="ibuprofen 400" />
            <ExampleChip query="4757811" label={t('home.cnkCode')} />
            <ExampleChip query="N02BE01" label={t('home.atcCode')} />
          </div>
        </div>
...
function ExampleChip({ query, label }: { query: string; label?: string }) {
  return (
    <a
